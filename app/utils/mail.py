...
class Mail :
    ...
    def add_vacation_notification (user, dates) :
        ...
        send_mail ("Prise de congée de " + user.nom + " " + user.prenom,
            [responsable.email],
            render_template ("app/templates/mail/addVacation.txt", user=user, responsable=responsable, dates=dates),
            "")#render_template ("app/templates/mail/addVacation.html", user=user, responsable=responsable, dates=dates))
